class CalcController {
    ...
    constructor(){
        ...
        this.#audio = new Audio('view/audio/click.mp3');
    ...
    copyToClipboard(){
        ...
        input.remove(); //Apenas pq está sendo utilizado SVG
    ...
    addOperation(value){
        ...
        if(isNaN(this.getLastOperation())) { //quando não for um numero (STRING)
